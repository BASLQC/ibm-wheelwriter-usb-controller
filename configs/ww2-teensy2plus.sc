#
## Personal Wheelwriter 2/Wheelwriter 1000/Wheelwriter 15 Matrix (US English)
## Modified for WW2/WW1000/WW15 by Antonizoon.
## Should work for most Lexmark-made Wheelwriters with the same layout.
# 
...
# (example) http://i.imgur.com/avVKbYg.jpg
# Strobe pins, 15 pin strip (0 = leftmost pin as pictured above)
# 1 : D0
# 2 : D1
# 3 : D2
# 4 : D3
...
matrix
   ...
   strobe   PD0      UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED 
   ...
   strobe   PC6      UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED   UNASSIGNED    LCTRL
